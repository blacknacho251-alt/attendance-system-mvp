...
import { Clock, Play, Square, Activity, Timer, CalendarCheck, MapPin } from 'lucide-react';
            ...
            {recentActivity.map((activity) => (
              <div key={activity.id} className="px-8 py-5 flex items-center justify-between hover:bg-slate-50/50 transition-colors">
                ...
                <div className="text-right">
                  ...
                  <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-success/10 text-success text-[10px] font-bold border border-success/10">
                    {activity.status}
                  </span>
                </div>
              </div>
